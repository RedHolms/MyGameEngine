...
// Make ABI definition
#define __MAKE_CURRENT_ABI_2__(FAMILY, ARCH) ABI_##FAMILY##_##ARCH
#define __MAKE_CURRENT_ABI_1__(FAMILY, ARCH) __MAKE_CURRENT_ABI_2__(FAMILY, ARCH)
#define CURRENT_ABI                          __MAKE_CURRENT_ABI_1__(CURRENT_ABI_FAMILY_CODENAME, CURRENT_ARCH_CODENAME)
